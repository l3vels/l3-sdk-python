...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'player_id': typing.Union[PlayerIdSchema, str, ],
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PlayerAsset']:
            return PlayerAsset

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PlayerAsset'], typing.List['PlayerAsset']],
    ...
    def __getitem__(self, i: int) -> 'PlayerAsset':
