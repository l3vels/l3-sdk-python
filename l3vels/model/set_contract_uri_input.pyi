...
class SetContractUriInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["game_id", "collection_id", "contract_uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["game_id", "collection_id", "contract_uri", ], str]):
