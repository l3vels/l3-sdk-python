...
class MintBatchInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["game_id", "collection_id", "player_address", "player_id", "assets", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["game_id", "collection_id", "player_address", "player_id", "assets", ], str]):
