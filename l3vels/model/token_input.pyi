...
class TokenInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "token_id", "asset_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["asset_id"]) -> typing.Union[MetaOapg.properties.asset_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "token_id", "asset_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        token_id: typing.Union[MetaOapg.properties.token_id, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        asset_id: typing.Union[MetaOapg.properties.asset_id, str, schemas.Unset] = schemas.unset,
